...
- Invalid month or doctor-count input now clears stale output before prompting the user to correct the fields
...
- Added a regression check for invalid input handling to `CONTRIBUTING.md`
